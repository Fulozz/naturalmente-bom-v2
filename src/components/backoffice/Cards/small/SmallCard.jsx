  ...
  return (
    <div className="rounded-lg shadow-lg bg-slate-50 dark:bg-slate-700 text-emerald-700 dark:text-slate-50 p-4">
      <div className="flex space-x-4">
        ...
        >
          { id === 1 ? (<ShoppingCart className="text-slate-50"/>) : id === 2 ? (<Loader2 className="text-slate-50"/>) : id === 3 ? (<RefreshCcw className="text-slate-50"/>) : id === 4 ? (<CheckCheck className="text-slate-50" />) : null }
        </div>
        <div className="">
          <p>{title}</p>
